...
//           <CardDescription>
//             Join TalentAI to find amazing opportunities
//           </CardDescription>
//         </CardHeader>
//         <CardContent>
...
//                       <div className="text-xs text-muted-foreground">Searching for talent</div>
//                     </div>
//                   </Label>
//                 </div>
//               </RadioGroup>
...
export const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // after signup, auth state will update and ProtectedRoute will redirect
      navigate('/')
    } catch (err: any) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div>
        <label>
          <input type="radio" checked={type === 'candidate'} onChange={() => setType('candidate')} />
          Candidate
        </label>
        <label>
          <input type="radio" checked={type === 'recruiter'} onChange={() => setType('recruiter')} />
          Recruiter
        </label>
      </div>
